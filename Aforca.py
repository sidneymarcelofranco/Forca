...
class arquivos:
    def __init__(self, root):
        ...
        root.title('Jogo da Forca | Copa do Mundo | Sidney M Franco')
        ...
        Label(self.canvas1, text='_________________________________________________').pack()
        Label(self.canvas1, text='Digite aqui', foreground='grey',justify=('center')).pack()
        ...
        self.msg=Label(self.canvas2, text='Acertos: ', foreground='grey',justify=('center'))
        self.msg.pack(side=LEFT)

        Label(self.canvas3, text='Letras Erradas:', foreground='red',justify=('center')).pack(side=LEFT)
        self.msg2=Label(self.canvas3, text=lista_erro)
        self.msg2.pack()
        self.msg3=Label(self.canvas4, text='')
        self.msg3.pack()
        self.msg4=Label(self.canvas4, text='')
        self.msg4.pack()
        self.msg5=Label(self.canvas4, text='https://www.scriptbrasil.com.br', foreground='grey',justify=('center'))
        self.msg5.pack()
    ...
    def forca(self, event):
        ...
        if len(digito) == len(lista_traco):
            self.msg3['text']='Parabéns! Seleção é: ' + palavra 
            self.msg3['fg']='green'
